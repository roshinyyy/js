 class FinalTile extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.tilemapTiledJSON('FinalTileIMG', 'assets/FinalTile.tmj');
    ...
    create() {
      // Create the tilemap
      const map = this.make.tilemap({ key: "FinalTileimg" });
      ...
      const pipoya = map.addTilesetImage('pippoya', 'pippoyaimg');
